...
public class HomeController {
    ...
    public HomeController(@Autowired MoviesClient moviesClient, @Autowired AlbumsClient albumsClient, @Autowired MovieFixtures movieFixtures, @Autowired AlbumFixtures albumFixtures) {
